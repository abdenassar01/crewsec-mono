...
const BUNDLE_ID = 'com.compiledideas.crewsec';
const PACKAGE = 'com.compiledideas.crewsec';
const NAME = 'crewsec';
const EXPO_ACCOUNT_OWNER = 'compiledideas';
const EAS_PROJECT_ID = 'b9bccc01-6d6e-4ddc-ad6c-6d541857472f';
const SCHEME = 'crewsec';
...
const client = z.object({
  ...
  VERSION: z.string(),
  API_URL: z.string(),
  BACKGROUND_NOTIFICATION_TASK: z.string(),
