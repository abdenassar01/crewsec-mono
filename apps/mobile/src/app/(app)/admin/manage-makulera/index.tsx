...
import { MakuleraByParkingList, ParkingsList } from '@/components/core';
import { Image, Text } from '@/components/ui';
import { cn } from '@/lib';

export default function ManageMakuleras() {
  ...
  return (
    <RootWrapper className="container">
      ...
      <View className="mt-2">
        ...
        {selectedParking ? (
          <MakuleraByParkingList id={selectedParking} />
        ) : (
          <ParkingsList
            resource="makulera"
